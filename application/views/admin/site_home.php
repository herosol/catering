                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="banner_heading1" rows="2" class="form-control" ><?= $row['banner_heading1'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="banner_detail1" class="control-label"> Short Detail 1<span class="symbol required">*</span></label>
                                <textarea name="banner_detail1" rows="2" class="form-control" required=""><?= $row['banner_detail1'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="banner_heading2" rows="2" class="form-control" ><?= $row['banner_heading2'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="banner_detail1" class="control-label"> Short Detail 2<span class="symbol required">*</span></label>
                                <textarea name="banner_detail2" rows="2" class="form-control" required=""><?= $row['banner_detail2'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <textarea name="banner_heading3" rows="2" class="form-control" ><?= $row['banner_heading3'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="banner_detail3" class="control-label"> Short Detail 3<span class="symbol required">*</span></label>
                                <textarea name="banner_detail3" rows="2" class="form-control" required=""><?= $row['banner_detail3'] ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="detail" class="control-label "> Heading 4<span class="symbol required">*</span></label>
                                <textarea name="banner_heading4" rows="2" class="form-control" ><?= $row['banner_heading4'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <label for="banner_detail1" class="control-label"> Short Detail 4<span class="symbol required">*</span></label>
                                <textarea name="banner_detail1" rows="2" class="form-control" required=""><?= $row['banner_detail1'] ?></textarea>
                            </div>
                        </div>
                    </div>
