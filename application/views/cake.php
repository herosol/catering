...
<html>
<head>
<title>Cake - Halo Catering</title>
...
<section id="banner">
	<div class="bannerSlider owl-carousel owl-theme" id="owl-SmBanner">
        <div class="item">
            <div class="image">
                <img src="images/background-wedding-cake.jpg">
            </div>
        </div>
        <div class="item">
            <div class="image">
                <img src="images/1986112.jpg">
            </div>
        </div>
        <div class="item">
            <div class="image">
                <img src="images/image-asset.jpg">
            </div>
        </div>
    </div>
</section>
