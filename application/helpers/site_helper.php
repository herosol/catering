...
function get_pages()
{
    $page_arr = array(1=>'index', 2=>'about-us', 3=>'loan-programs', 4=>'rate-calculator', 5=>'closed-loan', 6=>'forms', 7=> 'contact', 8=> 'lender-types', 9=> 'mortage-types', 10=>'key-concepts', 11=> 'qualification', 12=> 'loan-process', 13=> 'terms-to-know', 14=> 'faqs' );
    return $page_arr;  
}
